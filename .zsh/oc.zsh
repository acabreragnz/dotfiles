...
ocd() {
  ...
  print -u2 "ocd: opencode ${version:-unknown} todavia no soporta --dangerously-skip-permissions; usando OPENCODE_DANGEROUSLY_SKIP_PERMISSIONS=true por compatibilidad futura."
